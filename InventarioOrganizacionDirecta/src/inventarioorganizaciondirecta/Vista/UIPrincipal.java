package inventarioorganizaciondirecta.Vista;
import inventarioorganizaciondirecta.Controlador.ProductoControlador;
...
ProductoControlador controlador;
 ...
 initComponents();
    ...
    try {
        ...
        int total =
                controlador.getArchivo().totalRegistros();

        for (int i = 1; i <= total; i++) {

            Producto p =
                    controlador.getArchivo().leer(i);
